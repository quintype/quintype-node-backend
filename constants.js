...
const DEFAULT_REQUEST_TIMEOUT = process.env.NODE_ENV === "production" ? 4000 : 50000;

module.exports = { DEFAULT_DEPTH, DEFAULT_LIMIT, DEFAULT_STORY_FIELDS, DEFAULT_REQUEST_TIMEOUT };
